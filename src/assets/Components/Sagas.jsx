  ...
  return (
    ...
    <div className={styles.rows}>
      ...
      <div className={styles.box}>
          ...
          <div className={styles.box}>
          <a href="https://drive.google.com/drive/folders/1AdN3dWAE3tt9xJhsxMgY4q21Z9SRFtH2?usp=drive_link"><img src="https://m.media-amazon.com/images/I/81v3kQBVmQL._AC_UF1000,1000_QL80_.jpg" alt="" /></a>
          <h2 className={styles.txtam}>Peças Infernais</h2>
          </div>
    ...
    <div className={styles.box}>
        <a href="https://drive.google.com/drive/folders/1GCYKhgyoTTWvQF8596O5tmyQCWlFHSDU?usp=sharing"><img src="https://i.ytimg.com/vi/rJILkNsjoAE/hqdefault.jpg" alt="" /></a>
      ...
      <div className={styles.box}>
        <a href="https://drive.google.com/drive/folders/1FM0ueq7RT4X789Ht5yEur24ofbvqbxgl?usp=sharing"><img src="https://m.media-amazon.com/images/I/919dh4AX2hL._AC_UF1000,1000_QL80_.jpg" alt="" /></a>
    ...
    <div className={styles.box}>
      ...
      <div className={styles.box}>
        <a href="https://m.media-amazon.com/images/I/718rKQisF7L._AC_UF1000,1000_QL80_.jpg"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQpdhAV6J3fMO0JZ-TvgFvkC1RgXrNsGGU6hg&s" alt="" /></a>
        <h2 className={styles.txtam}>Percy Jackson e os Olimpianos</h2>
      </div>
    ...
    <div className={styles.box}>
        <a href="https://drive.google.com/drive/folders/10ODG1kpiRAT0IyaL1S6-yJeQQJFPdTUF?usp=sharing"><img src="https://m.media-amazon.com/images/I/613qEqF6DNL._AC_UF1000,1000_QL80_.jpg" alt="" /></a>
      ...
      <div className={styles.box}>
        <a href="https://drive.google.com/drive/folders/12iXV9wwE-WjGoo6xuvfRVbbOqCtYDUA8?usp=sharing"><img src="https://images.dlivros.org/Rick-Riordan/semideuses-magos-rick-riordan_large.webp" alt="" /></a>
      ...
      <div className={styles.box}>
        <a href="https://drive.google.com/drive/folders/13IENQiptW7ypTWhW-LsLYviFvZYPD_6g?usp=sharing"><img src="https://m.media-amazon.com/images/I/71DHJpr22rL._AC_UF1000,1000_QL80_.jpg" alt="" /></a>
    ...
    <div className={styles.box}>
      ...
      <div className={styles.box}>
        <a href="https://drive.google.com/drive/folders/16vU8sZgtLOUnn2b7I8Owb6QFl3ED2O_0?usp=sharing"><img src="https://m.media-amazon.com/images/I/51gQ8mqIiGL.jpg" alt="" /></a>
      ...
      <div className={styles.box}>
        <a href="https://drive.google.com/drive/folders/16lpG9VwJEvNd8PR6jSTIK8FDnc0ci6-I?usp=sharing"><img src="https://miro.medium.com/v2/resize:fit:1400/1*eXqdZ3kwoS6SEEx0WrwOZA.jpeg" alt="" /></a>
        <h2 className={styles.txtam}>Machado de Assis</h2>
      </div>
